...
const DeleteModal = ({open, close, item, updateState, addItemToState}) => {
    ...
    return (
        <div className="mx-auto max-w-[1320px]">
            <Dialog open={open} confirm={close} cancel={close} title={item ? 'Editar' : 'Cadastrar'} confirmLabel={'Enviar'} cancelLabel="Cancelar">
